...
defineOptions({ name: 'Departmental Management' })
      ...
      return [
        ...
        h(
          ...
          },
          {
            ...
            default: () => h('div', {}, 'Are you sure you want to delete this department?'),
          }
        ),
      ]
    },
    ...
    <template #action>
      <div>
        <NButton
          ...
          @click="addDepts"
        >
          <TheIcon icon="material-symbols:add" :size="18" class="mr-5" />New Department
        </NButton>
      </div>
    </template>
    <!-- Table -->
    ...
    >
      ...
      >
        ...
        <NFormItem label="Department Name" path="name">
          <NInput v-model:value="modalForm.name" clearable placeholder="Please enter the department name" />
        </NFormItem>
